...
![](plot_housing_stress_by_lifecycle.png){fig-align="center" }
...
## Model Setup Preview: 
- **Dependent Variable**: Whether a household faces housing stress (binary: Yes/No)  
- **Independent Variables**:  
  - Life cycle stage  
  - Education level  
  - State (regional location)  
  - Tenure type (e.g., rental, social housing)  
  - Affordability ratio  
  - Household size  
...
1. Household Size:  
Larger households reduce housing stress (1-person increase → ~18% lower odds).

2. Age of Youngest Child:  
Slight trend: older children may slightly lower stress.


3. Purchase Price of Dwelling:
Original purchase price not a key driver; ongoing affordability matters.

4. Affordability Ratio:
Strongest predictor; higher share of income spent on housing → much higher stress.
