...
```{r}
#Weekly housing costs (broad) as a percentage of gross hh income (exc RA) ranges: HCOST10A
...
explore2019<- svy_afford_2019 %>%
  select( HCOST10A,life_cycle_group, PERSHBC,afford_ratio, LVLEDUA,AGEKIDH, STATEHEC)
```
