...
```{r}
# Boxplot: Household size vs housing stress
ggplot(explore2019, aes(x = factor(HousingStress), y = factor(Household_Size), fill = factor(HousingStress))) +
  geom_boxplot() +
  labs(
    title = "Household Size by Housing Stress",
    x = "Housing Stress",
    y = "Household Size (categories)"
  ) +
  scale_x_discrete(labels = c("0" = "Not stressed", "1" = "Stressed")) +
  theme_minimal()
...
```{r}
ggplot(explore2019, aes(x = factor(HousingStress), y = Education_Level, fill = factor(HousingStress))) +
  geom_boxplot() +
  labs(
    title = "Education Level by Housing Stress",
    x = "Housing Stress",
    y = "Education Level"
  ) +
  theme_minimal()
